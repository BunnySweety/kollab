<script lang="ts">
	...
	// SvelteKit props - declared to avoid console warnings
	export let data: any;
	...
	async function handleSubmit(e: Event) {
		...
		try {
			...
			log.error('Registration error', error instanceof Error ? error : new Error(String(error)), { email });
...
<svelte:head>
	<title>Sign Up - Kollab</title>
	<meta name="description" content="Create your Kollab account" />
</svelte:head>
	...
	<div class="w-full max-w-md">
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Start your journey with a free Kollab workspace
				</CardDescription>
			</CardHeader>
